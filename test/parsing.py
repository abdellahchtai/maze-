...
def check_width(value: str) -> str | bool:
    ...
    try:
        ...
        if width > 42:
            return "WIDTH must lower than 42"
        return True
    except ValueError:
...
def check_height(value: str) -> str | bool:
    ...
    try:
        ...
        if height > 42:
            return "HEIGHT must lower than 42"
        return True
    except ValueError:
...
def parse_config(file_name: str) -> Dict | str: 
    ...
    try:
        with open(file_name, "r") as file:
            ...
            perfect = items["PERFECT"]
            maze = MazeGenerator(items["WIDTH"], items["HEIGHT"],  entry_coord, exit_coord, perfect)
